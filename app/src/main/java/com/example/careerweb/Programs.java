...
public class Programs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.programsRecyclerView);
        ...
        myDB = new DatabaseAccess(Programs.this);
        ...
        universityAdapter = new ProgramAdapter(Programs.this,this, book_id, book_title, book_author,
                book_pages);
    ...
    void confirmDialog(){
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                DatabaseAccess myDB = new DatabaseAccess(Programs.this);
                myDB.deleteAllCourses();
                //Refresh Activity
                Intent intent = new Intent(Programs.this, Programs.class);
                startActivity(intent);
                finish();
            }
        });
